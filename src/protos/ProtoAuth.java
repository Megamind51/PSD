...
public final class ProtoAuth {
  ...
  public interface AuthOrBuilder extends
    ...
    /**
     * <code>int32 notification_port = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 48: {
              ...
              notificationPort_ = input.readInt32();
              break;
            }
            default: {
    ...
    public static final int NOTIFICATION_PORT_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (notificationPort_ != 0) {
        output.writeInt32(6, notificationPort_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (notificationPort_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(6, notificationPort_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNotificationPort()
          != other.getNotificationPort()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NOTIFICATION_PORT_FIELD_NUMBER;
      hash = (53 * hash) + getNotificationPort();
    ...
    public static final class Builder extends
      ...
      public ProtoAuth.Auth buildPartial() {
        ...
        result.notificationPort_ = notificationPort_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(ProtoAuth.Auth other) {
        ...
        if (other.getNotificationPort() != 0) {
          setNotificationPort(other.getNotificationPort());
        }
  ...
  checkByteStringIsUtf8(value);
      ...
      /**
       * <code>int32 notification_port = 6;</code>
       * @param value The notificationPort to set.
       * @return This builder for chaining.
       */
      public Builder setNotificationPort(int value) {
        
        notificationPort_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearNotificationPort() {
  ...
  static {
    ...
    internal_static_Auth_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Auth_descriptor,
        new java.lang.String[] { "Operation", "Type", "Username", "Password", "Authenticated", "NotificationPort", });
  }
