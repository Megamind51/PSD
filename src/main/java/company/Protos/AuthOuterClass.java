package company.Protos;// Generated by the protocol buffer compiler.  DO NOT EDIT!
// source: auth.proto
...
public final class AuthOuterClass {
  ...
  public interface AuthOrBuilder extends
     ...
     */
    AuthOuterClass.Auth.Operation getOperation();
     ...
     * @return The type.
     */
    AuthOuterClass.Auth.Type getType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AuthOuterClass.internal_static_Auth_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AuthOuterClass.Auth.class, AuthOuterClass.Auth.Builder.class);
    }
    ...
    public enum Operation
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AuthOuterClass.Auth.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public enum Type
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return AuthOuterClass.Auth.getDescriptor().getEnumTypes().get(1);
      }
     ...
     * @return The operation.
     */
    public AuthOuterClass.Auth.Operation getOperation() {
      @SuppressWarnings("deprecation")
      AuthOuterClass.Auth.Operation result = AuthOuterClass.Auth.Operation.valueOf(operation_);
      return result == null ? AuthOuterClass.Auth.Operation.UNRECOGNIZED : result;
    }
     ...
     * @return The type.
     */
    public AuthOuterClass.Auth.Type getType() {
      @SuppressWarnings("deprecation")
      AuthOuterClass.Auth.Type result = AuthOuterClass.Auth.Type.valueOf(type_);
      return result == null ? AuthOuterClass.Auth.Type.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (operation_ != AuthOuterClass.Auth.Operation.LOGIN.getNumber()) {
        output.writeEnum(1, operation_);
      }
      if (type_ != AuthOuterClass.Auth.Type.MANUFACTURER.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AuthOuterClass.Auth)) {
        return super.equals(obj);
      }
      AuthOuterClass.Auth other = (AuthOuterClass.Auth) obj;
    ...
    public static AuthOuterClass.Auth parseFrom(
    ...
    public static AuthOuterClass.Auth parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AuthOuterClass.Auth parseFrom(
    ...
    public static AuthOuterClass.Auth parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AuthOuterClass.Auth parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AuthOuterClass.Auth parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AuthOuterClass.Auth prototype) {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public AuthOuterClass.Auth getDefaultInstanceForType() {
        return AuthOuterClass.Auth.getDefaultInstance();
      }

      @java.lang.Override
      public AuthOuterClass.Auth build() {
        AuthOuterClass.Auth result = buildPartial();
      ...
      @java.lang.Override
      public AuthOuterClass.Auth buildPartial() {
        AuthOuterClass.Auth result = new AuthOuterClass.Auth(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AuthOuterClass.Auth) {
          return mergeFrom((AuthOuterClass.Auth)other);
        } else {
      ...
      public Builder mergeFrom(AuthOuterClass.Auth other) {
        if (other == AuthOuterClass.Auth.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AuthOuterClass.Auth parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AuthOuterClass.Auth) e.getUnfinishedMessage();
       ...
       * @return This builder for chaining.
       */
      public Builder setOperation(AuthOuterClass.Auth.Operation value) {
        if (value == null) {
       ...
       * @return This builder for chaining.
       */
      public Builder setType(AuthOuterClass.Auth.Type value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
    ...
    static {
      DEFAULT_INSTANCE = new AuthOuterClass.Auth();
    }
