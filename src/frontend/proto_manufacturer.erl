...
-spec encode_msg('ManufacturerRequest'(), atom()) -> binary().
encode_msg(Msg, MsgName) when is_atom(MsgName) ->
    encode_msg(Msg, MsgName, []).

-spec encode_msg('ManufacturerRequest'(), atom(), list()) -> binary().
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      'ManufacturerRequest' ->
	  encode_msg_ManufacturerRequest(id(Msg, TrUserData),
					 TrUserData)
    end.


encode_msg_ManufacturerRequest(Msg, TrUserData) ->
    encode_msg_ManufacturerRequest(Msg, <<>>, TrUserData).
...
decode_msg_2_doit('ManufacturerRequest', Bin,
		  TrUserData) ->
    id(decode_msg_ManufacturerRequest(Bin, TrUserData),
       TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      'ManufacturerRequest' ->
	  merge_msg_ManufacturerRequest(Prev, New, TrUserData)
    end.

-compile({nowarn_unused_function,merge_msg_ManufacturerRequest/3}).
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      'ManufacturerRequest' ->
	  v_msg_ManufacturerRequest(Msg, [MsgName], TrUserData);
      _ -> mk_type_error(not_a_known_message, Msg, [])
    end.


-compile({nowarn_unused_function,v_msg_ManufacturerRequest/3}).
...
v_msg_ManufacturerRequest(#{} = M, Path, TrUserData) ->
    ...
    lists:foreach(fun (manufacturer) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_ManufacturerRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'ManufacturerRequest'},
		  M, Path);
v_msg_ManufacturerRequest(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'ManufacturerRequest'}, X,
		  Path).
...
get_msg_names() -> ['ManufacturerRequest'].


get_group_names() -> [].


get_msg_or_group_names() -> ['ManufacturerRequest'].
...
fqbin_to_msg_name(<<"ManufacturerRequest">>) -> 'ManufacturerRequest';
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin('ManufacturerRequest') -> <<"ManufacturerRequest">>;
...
source_basename() -> "proto_manufacturer.proto".
...
%% functions.
get_all_proto_names() -> ["proto_manufacturer"].


get_msg_containment("proto_manufacturer") ->
    ['ManufacturerRequest'];
get_msg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_pkg_containment("proto_manufacturer") -> undefined;
get_pkg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_service_containment("proto_manufacturer") -> [];
get_service_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_rpc_containment("proto_manufacturer") -> [];
get_rpc_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_enum_containment("proto_manufacturer") -> [];
get_enum_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_proto_by_msg_name_as_fqbin(<<"ManufacturerRequest">>) ->
    "proto_manufacturer";
